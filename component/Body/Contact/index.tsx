...
const Contact = ({ setActive }: { setActive: () => void }) => {
  return (
    <div
      id="Contact"
      className="flex flex-col gap-20 height-full justify-center text-black w-full px-5 md:px-20 py-16"
      onFocus={() => setActive()}
    >
      <div className="text-3xl md:text-5xl text-black align-center font-bold w-full md:max-w-[900px]">
