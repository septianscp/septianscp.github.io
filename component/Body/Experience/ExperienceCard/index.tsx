...
const ExperienceCard = ({ item: {
    ...
    return (
        <div className={`flex gap-8 border border-gray-500 w-full px-6 py-8 rounded-lg ${isEven ? "bg-gray-700" : "bg-black"}`}>
            <div className="flex flex-col gap-7 w-full" >
                <div className="flex flex-col md:flex-row justify-between gap-4 md:gap-0">
                    ...
                    <div className="text-base text-gray-100 md:text-white">{year}</div>
                </div>
